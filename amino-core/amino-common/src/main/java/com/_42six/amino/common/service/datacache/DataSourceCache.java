 ...
 */
public class DataSourceCache extends SortedIndexCache<Text> {

    public static final String SUBDIR = "/datasources";

    public DataSourceCache() {
        super(SUBDIR);
    }

    public DataSourceCache(Configuration conf) throws IOException {
        super(SUBDIR, conf);
    }
