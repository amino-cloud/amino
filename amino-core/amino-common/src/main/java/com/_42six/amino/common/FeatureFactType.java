...
{
	NOMINAL(0, Text.class), ORDINAL(1, Text.class), INTERVAL(2, DoubleWritable.class), RATIO(3, DoubleWritable.class), DATE(4, Text.class), DATEHOUR(5, Text.class), POLYGON(6, PolygonWritable.class), POINT(7, CoordinateWritable.class);
