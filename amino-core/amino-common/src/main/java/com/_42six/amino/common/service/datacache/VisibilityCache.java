 ...
 */
public class VisibilityCache extends SortedIndexCache<Text> {

    public static final String SUBDIR = "/visibilities";

    public VisibilityCache() {
        super(SUBDIR);
    }

    public VisibilityCache(Configuration conf) throws IOException {
        super(SUBDIR, conf);
    }
